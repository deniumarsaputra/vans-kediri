...
module.exports = {
  get: {
    ...
    description:
      "Endpoint untuk mengambil semua data system user",
    response: {
      200: {
  ...
  getById: {
    ...
    description:
      "Endpoint untuk mengambil detail data system user",
    response: {
      200: {
        description: "Successful response",
        type: "object",
  ...
  post: {
    ...
    description:
      "Endpoint untuk menambah data system user",
    body: {
        type: "object",
  ...
  put: {
    ...
    description:
      "Endpoint untuk update data system user",
    response: {
      200: {
        description: "Successful response",
        type: "object",
  ...
  deletes:{
    ...
    description:
      "Endpoint untuk hapus data system user",
    response: {
      200: {
        description: "Successful response",
        type: "object",
